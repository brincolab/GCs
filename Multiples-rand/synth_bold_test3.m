clear;
addpath("../");
load longer_synth_bold_sig.mat;
...
for r=1:n_runs
    for c=1:nc
        ...
        display(['random columns:', mat2str(randcolums)])
        for t=1:nts
            T = Ts(t);
...
%    cleg,'location','best')
savefig("figures/TC-12990-unfiltered.fig")
...
%legend([pp{1}.mainLine,pp{2}.mainLine,pp{3}.mainLine,pp{4}.mainLine],...
%    cleg,'location','best')
savefig("figures/TC-12990-unfiltered-zoom.fig")
...
%legend([pp{1}.mainLine,pp{2}.mainLine,pp{3}.mainLine,pp{4}.mainLine],...
%    cleg,'location','best')
savefig("figures/DTC-12990-unfiltered.fig")
...
%legend([pp{1}.mainLine,pp{2}.mainLine,pp{3}.mainLine,pp{4}.mainLine],...
%    cleg,'location','best')
savefig("figures/DTC-12990-unfiltered-Zoom.fig")
...
%legend([pp{1}.mainLine,pp{2}.mainLine,pp{3}.mainLine,pp{4}.mainLine],...
%    cleg,'location','best')
savefig("figures/TC-12990-unfiltered_time.fig")
...
%legend([pp{1}.mainLine,pp{2}.mainLine,pp{3}.mainLine,pp{4}.mainLine],...
%    cleg,'location','best')
savefig("figures/DTC-12990-unfiltered_time.fig")