...
%      10000 11000 12000 12990 15000 20000 30000 40000 50000 59990];
%Ts(1) = 100;
Cols = [3];

load bold_60000_filt.mat
bold = bold_filt(:,11:60000);
...
for r=1:1
    for c=1:nc
        for t=1:nts
            ...
            save results/filtered/synth_bold_60k_calcs_filt.mat Ts gaussian_tc gaussian_dtc kraskov_tc kraskov_dtc est_tc est_dtc
            save results/filtered/synth_bold_60k_times_filt.mat gaussian_tc_time gaussian_dtc_time kraskov_tc_time kraskov_dtc_time est_tc_time est_dtc_time temp_times
            save results/filtered/synth_bold_60k_surrogates_filt.mat surrogates_jg_tc surrogates_jg_dtc surrogates_jk_tc surrogates_jk_dtc surrogates_gc_tc surrogates_gc_dtc
        end
